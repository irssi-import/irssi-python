...
static PY_SIGNAL_SPEC_REC py_sigmap[] = {
    ...
    {"server cap ack ", "S", 0, 0, 1},
    {"server cap nak ", "S", 0, 0, 1},
    {"server cap new ", "S", 0, 0, 1},
    {"server cap delete ", "S", 0, 0, 1},
    {"server cap end", "S", 0, 0, 0},
    {"server cap req", "Ss", 0, 0, 0},
    {"server sasl failure", "Ss", 0, 0, 0},
    {"server sasl success", "S", 0, 0, 0},
    {"server event", "Ssss", 0, 0, 0},
    {"server event tags", "Sssss", 0, 0, 0},
    {"event ", "Ssss", 0, 0, 1},
    ...
    {"autoignore new", "Sg", 0, 0, 0},
    {"autoignore remove", "Sg", 0, 0, 0},
    {"flood", "Sssis", 0, 0, 0},
    ...
    {"proxy client connecting", "?", 0, 0, 0},
    {"proxy client connected", "?", 0, 0, 0},
    {"proxy client disconnected", "?", 0, 0, 0},
    {"proxy client command", "?ss", 0, 0, 0},
    {"proxy client dump", "?s", 0, 0, 0},
    ...
    {"message invite_other", "Sssss", 0, 0, 0},
    {"message topic", "Sssss", 0, 0, 0},
    {"message host_changed", "Ssss", 0, 0, 0},
    {"message account_changed", "Ssss", 0, 0, 0},
    {"message away_notify", "Ssss", 0, 0, 0},
    {"keyinfo created", "?", 0, 0, 0},
    {"keyinfo destroyed", "?", 0, 0, 0},
    {"print text", "tss", 0, 0, 0},
    {"print format", "TstF", 0, 0, 0},
    {"print noformat", "ts", 0, 0, 0},
    {"theme created", "T", 0, 0, 0},
    {"theme destroyed", "T", 0, 0, 0},
    {"window hilight", "w", 0, 0, 0},
    {"window hilight check", "tsII", 0, 0, 0},
    {"window dehilight", "w", 0, 0, 0},
    ...
    {"default event numeric", "Ssss", 0, 0, 0},
    ...
    {"beep", "", 0, 0, 0},
    {"gui print text after finished", "w??", 0, 0, 0},
    {"gui textbuffer line removed", "???", 0, 0, 0},
    {"otr event", "Sss", 0, 0, 0},
    {NULL}
};
